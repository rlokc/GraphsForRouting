...
public class Node {
    ...
    private ArrayList<Node> proxPathTo = null;

    public ArrayList<Node> getProxPathTo() {
        return proxPathTo;
    }

    public void setProxPathTo(ArrayList<Node> proxPathTo) {
        this.proxPathTo = proxPathTo;
    }
